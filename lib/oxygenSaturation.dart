    ...
    try {
      ...
      if (currentSpO2 == 0) {
        ...
        prompt = '''
          ...
          and briefly explaining why tracking blood oxygen is helpful.
        ''';
      } else {
        // --- THE CLINICAL PROMPT (HAS DATA) ---
        prompt = '''
          The user, $userName, has a current blood oxygen saturation (SpO2) of $currentSpO2% and a daily average of $avgSpO2%.
